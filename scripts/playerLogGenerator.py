...
def generate_robot():
    return {
        ...
        "pose": [random.uniform(-7.000, 7.000), random.uniform(-11.000, 11.000), random.uniform(-1.000, 5.000)],
        "targetPose": [random.uniform(-7.000, 7.000), random.uniform(-10.000, 10.000), random.uniform(-1.000, 5.000)],
        "velocity": [random.uniform(0, 5), random.uniform(0, 5), random.uniform(0, 5)],
...
def generate_ball():
    return {
        "position": [random.uniform(-7.000, 7.000), random.uniform(-10.000, 10.000), random.uniform(-1.000, 5.000)],
        "velocity": [random.uniform(0, 5), random.uniform(0, 5), random.uniform(0, 5)],
